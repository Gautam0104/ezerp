    ...
    <section className="py-5" style={{ backgroundColor: "#f8f9fa" }}>
      <div className="container">
        ...
        <ul className="list-group list-group-flush">
          ...
          <li className="list-group-item bg-transparent border-0">
            <strong>[4]</strong> <br /> Microsoft 365 Personal or Family
          ...
          <li className="list-group-item bg-transparent border-0">
            ...
            product, and domain selections on Microsoft.{" "}
            <Link to="">Learn more</Link>. Cancel your Microsoft 365
            subscription any time by going to the Microsoft 365 admin center.
