...
const resources = [
  ...
  },
  {
    ...
    title: "Use visual aids to increase the impact of your speeches and presentations.",
    link: "#",
  },
  {
    img: resourceImg3,
...
const moreResources = [
  {
    img: imageIcon,
    tag: "Microsoft Word",
    title: "Elevate your writing and create beautiful documents—anywhere, anytime.",
    link: "#",
  },
  {
    img: imageIcon,
  ...
  },
  {
  ...
  },
   {
    ...
    title: "Keep your files and memories protected, up to date, and easily accessible across all your devices.",
    link: "#",
  },
   {
    img: imageIcon,
  ...
  },
   {
    img: imageIcon,
    tag: "Teams",
    title: "Bring everyone together in one place to meet, chat, call, and collaborate.",
    link: "#",
  },
];
  ...
  return (
    <div className="bg-light" style={{ minHeight: "100vh", padding: "40px 0" }}>
      <div className="container" >
        <div className="text-primary fw-semibold text-uppercase mb-2" style={{ letterSpacing: 1, fontSize: 14 }}>
          RESOURCES
        </div>
            ...
            {resources.map((res, idx) => (
              ...
              >
                ...
                <div style={{ padding: 32, flex: 1, display: "flex", flexDirection: "column" }}>
                  <div className="fw-medium mb-2 text-primary" style={{ fontSize: 12 }}>
                    {res.tag}
                  </div>
                  <div className="fw-semibold mb-4" style={{ fontSize: 22, color: "#111", lineHeight: 1.3 }}>
                    {res.title}
                  </div>
                  <a
                    href={res.link}
