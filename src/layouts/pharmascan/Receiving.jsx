...
const Receiving = () => {
  return (
    <div className="flex-grow-1 px-4">
      ...
      {/* Content Area */}
      <div className="bg-white p-4 rounded shadow my-4" style={{ height: 'calc(100vh - 100px)', overflowY: 'auto' }}>
        ...
        <p className="text-muted mb-4">Manage incoming shipments and verify inventory</p>
        ...
        <ul className="nav nav-tabs mb-3">
          <li className="nav-item">
            <Link className="nav-link active text-primary" to="#">Expected Shipments</Link>
          </li>
          <li className="nav-item">
            <Link className="nav-link text-secondary" to="#">Shipment History</Link>
          </li>
        </ul>
            ...
            <tbody>
              {[
                ...
                <tr key={idx}>
                  ...
                  <td>{row.items}</td>
                  <td>
                    <button className={`btn btn-sm text-${row.statusColor} bg-${row.statusColor} bg-opacity-25 rounded-pill`}>
                      {row.status}
                    </button>
                  </td>
                  <td>
