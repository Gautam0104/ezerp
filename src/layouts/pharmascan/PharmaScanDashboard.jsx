...
export default function PharmaScanDashboard() {
  return (
    <div className="container-fluid px-3 px-md-4">
      {/* Header */}
      <div className="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center shadow p-3 p-md-4 bg-white text-primary gap-3">
        <a
          href="pharmaScan.html"
          className="btn btn-outline-primary fw-semibold fs-5 fs-md-4"
        >
